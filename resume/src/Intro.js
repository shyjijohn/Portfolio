...
export default function Intro() {
    return (
        <div className=' self-start ml-5 lg:self-auto mt-10 lg:-mt-44 lg:ml-10 xl:-mt-44 xl:ml-20 2xl:-mt-44 2xl:ml-40'>
            ...
            <div className="flex flex-col">
                ...
                <div className="self-start text-xl md:text-4xl font-light xl:mt-4">Frontend developer</div>
            </div>
        </div>
    )
}
